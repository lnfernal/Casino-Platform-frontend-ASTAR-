...
import { FaLink, FaCloudUploadAlt, FaCoins } from "react-icons/fa";
        ...
        <div className="col-lg-4 col-md-6 mb-3">
            <div className="feature-box f-boxed style-3">
                <Reveal
                    ...
                    triggerOnce
                >
                    <FaCloudUploadAlt className="reveal-item" />
                    {/* <img
